...
#define GPRS_pw "tm"
#define TRACKING_URL "www.trackingdomain.de/gps.php?visor=false&latitude=%s&longitude=%s&altitude=%s&time=%s&satellites=%s&speedOTG=%s&course=%s"
